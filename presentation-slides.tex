...
\author{Étudiant XYZ \and Étudiant ABC}
\institute{Université de [Nom Université]}
...
\begin{frame}{Glossaire Technique - Orthodontie}
  \begin{description}
      ...
      \item[ANB] Angle céphalométrique (points A-N-B). Normal : 2-4°. ANB $<0°$ = Classe III squelettique (Règle R-A4).
